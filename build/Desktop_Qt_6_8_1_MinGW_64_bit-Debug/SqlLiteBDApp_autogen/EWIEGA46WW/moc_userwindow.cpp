...
static constexpr auto qt_meta_stringdata_ZN10UserWindowE = QtMocHelpers::stringData(
    "UserWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10UserWindowE[] = {
...
Q_CONSTINIT const QMetaObject UserWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10UserWindowE.offsetsAndSizes,
    qt_meta_data_ZN10UserWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10UserWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *UserWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10UserWindowE.stringdata0))
